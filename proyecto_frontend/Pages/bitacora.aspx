<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bitacora.aspx.cs" Inherits="proyecto_frontend.Pages.bitacora" %>
...
<head runat="server">
    ...
    <title>Bitácora — InvControl Pro</title>
        ...
        <div class="app-shell">
            ...
            <header class="topbar" role="banner">
                ...
                <div class="tb-status" role="status" aria-label="Estado del sistema: en línea">
                    <div class="tb-status-dot" aria-hidden="true"></div>
                    <span>En línea</span>
                </div>
                ...
                <div class="tb-avatar"
                    title="Carlos Admin"
                    role="img"
                    aria-label="Usuario: Carlos Admin">
                    CA
                </div>
            </header>
            ...
            <div class="body-wrap">
                ...
                <nav class="sidebar" id="sidebar" aria-label="Navegación principal">
                    ...
                    <div class="nav-section">
                        ...
                        <a class="nav-item active" href="Bitacora.aspx" aria-current="page">
                            <span class="nav-icon" aria-hidden="true">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M4 6H20V18H4V6Z" stroke="currentColor" stroke-width="1.5" fill="none" />
                                    <path d="M8 6V4H16V6" stroke="currentColor" stroke-width="1.5" fill="none" />
